...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            # train_df['total score'] = train_df['math_score'] + train_df['reading_score'] + train_df['writing_score']
            # test_df['total score'] = test_df['math_score'] + test_df['reading_score'] + test_df['writing_score']
